...
## Add Custom Fields for Booking Details

Custom fields are perfect for recording travel-related information directly on records. When managing bookings, you might want fields for:

- **Number of travelers**
- **Desired accommodations**
- **Dietary restrictions**

Create these fields from **Settings → Data Model** by selecting either the `People` object or your `Safari Tour` object and clicking **Add Field**.
